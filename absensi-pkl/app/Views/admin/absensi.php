...
<div class="card">
    ...
    <form method="get" action="?r=admin/absensi" class="filter-form">
        <div class="form-row">
            <div class="form-group">
                <label for="searchSiswa">Cari Siswa:</label>
                <input type="text" id="searchSiswa" name="search" 
                       value="<?= htmlspecialchars($_GET['search'] ?? '') ?>" 
                       placeholder="Nama atau NIS siswa..." class="form-control">
            </div>
            
            <div class="form-group">
                <label for="filterDate">Filter Tanggal:</label>
                <input type="date" id="filterDate" name="date" 
                       value="<?= htmlspecialchars($_GET['date'] ?? '') ?>" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <select id="filterStatus" name="status" class="form-control">
                    ...
                    <option value="dalam" <?= ($_GET['status'] ?? '') === 'dalam' ? 'selected' : '' ?>>Dalam Radius</option>
                    <option value="luar" <?= ($_GET['status'] ?? '') === 'luar' ? 'selected' : '' ?>>Luar Radius</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <a href="?r=admin/absensi" class="btn btn-secondary">
                    🔄 Reset
                </a>
            </div>
        </div>
