    ...
    <div class="profile-content">
        ...
        <div class="settings-section danger-zone">
            ...
            <div class="danger-actions">
                <form method="POST" action="?r=profile/reset" 
                      onsubmit="return confirm('⚠️ PERHATIAN! Semua pengaturan akan direset ke default. Tindakan ini tidak dapat dibatalkan. Lanjutkan?')">
                    <input type="hidden" name="csrf_token" value="<?= \App\Helpers\CSRF::token() ?>">
