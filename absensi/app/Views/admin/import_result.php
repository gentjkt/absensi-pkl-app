...
<div class="card">
  ...
  <?php if($success_count > 0): ?>
    <div class="alert alert-info" style="margin-top: 20px;">
      ...
      <p><strong>Username:</strong> Sesuai data CSV (contoh: john_doe)</p>
      <p><strong>Password:</strong> Sesuai data CSV (contoh: 123456)</p>
      <p><strong>Role:</strong> Siswa</p>
      <p class="text-muted">
        <small>
          Setiap siswa memiliki username dan password yang berbeda sesuai data CSV. 
          Siswa dapat login dengan kredensial yang telah diimport.
        </small>
      </p>
    </div>
  <?php endif; ?>
...
<div class="card">
  ...
  <?php if($success_count > 0): ?>
    <div class="alert alert-success" style="margin-top: 20px;">
      ...
      <ul>
        <li>🔐 Login siswa dengan username dan password sesuai CSV</li>
      ...
      <div class="info" style="margin-top: 15px;">
        ...
        <p><strong>Format Login:</strong> <code>Username: Sesuai CSV, Password: Sesuai CSV</code></p>
        <p><strong>Contoh:</strong> Jika ada siswa dengan username "john_doe" dan password "123456", maka:</p>
        <ul>
